...
static inline void move_fun2(char* dest, char* source, char num){
  //int source_height = *source;
  memcpy(dest + *dest + 1, source + *source - num +1, num);
  *dest += num;
  *source -= num;
}
